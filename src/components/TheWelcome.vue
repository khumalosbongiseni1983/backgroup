    ...
    <div class="site_body" v-if="design == 3">
      ...
      <div class="main_2" v-else-if="main_1 == 2">
        ...
        <div class="input">
          ...
          <input type="input" class="input" placeholder="Group id">
        </div>
        <div class="input">
        ...
        <div class="reson">
          <div class="radio">
            <input type="radio" name="checkbox" class="checkbox">
            <label for="age1">You have been hijacked by admin rights</label><br>
          </div>
          <div class="radio">
            <input type="radio" name="checkbox" class="checkbox">
            <label for="age1">Your account has been hacked</label><br>
          </div>
          <div class="radio">
            <input type="radio" name="checkbox" class="checkbox">
      ...
      <div class="main_2" v-else>
        <p>You are now an administrator, thank you!</p>
        <div class="input-next">
